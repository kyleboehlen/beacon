...
const defaultOptions = {
  ...
  workerSrc: {
    value: "../build/pdfjs.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.defaultUrl = {
    value: "compressed.tracemonkey-pldi-09.pdfjs",
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
    value: "../build/pdfjs.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
...
class DownloadManager {
  ...
  openOrDownloadData(data, filename, dest = null) {
    ...
    const contentType = isPdfData ? "application/pdfjs" : "";
    if (isPdfData) {
  ...
  async run(config) {
    ...
    appConfig.mainContainer.addEventListener("dragover", function (evt) {
      for (const item of evt.dataTransfer.items) {
        if (item.type === "application/pdfjs") {
    ...
    appConfig.mainContainer.addEventListener("drop", function (evt) {
      if (evt.dataTransfer.files?.[0].type !== "application/pdfjs") {
        return;
      }
      stopEvent(evt);
      eventBus.dispatch("fileinputchange", {
